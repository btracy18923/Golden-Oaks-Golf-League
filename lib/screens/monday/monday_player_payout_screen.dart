...
class MondayPlayerPayoutScreen extends StatefulWidget {
  const MondayPlayerPayoutScreen({super.key});

  @override
  State<MondayPlayerPayoutScreen> createState() => _MondayPlayerPayoutScreenState();
}

class _MondayPlayerPayoutScreenState extends State<MondayPlayerPayoutScreen> {
  // Hard-coded Monday league
