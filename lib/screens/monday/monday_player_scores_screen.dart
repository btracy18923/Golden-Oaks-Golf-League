...
class MondayPlayerScoresScreen extends StatefulWidget {
  const MondayPlayerScoresScreen({super.key});
...
class _MondayPlayerScoresScreenState extends State<MondayPlayerScoresScreen> {
  ...
  static const String _leagueTitle = 'Monday League Player Scores';
  ...
  Future<void> _loadPlayerScores(String playerLast) async {
    setState(() => _isLoading = true);
    try {
      final scores = await _databaseHelper.getPlayerScoreHistory(playerLast, League.monday);
      setState(() {
        _scores = scores;
        _isLoading = false;
      });
          ...
          children: [
            ...
            if (_selectedPlayer != null) ...[
              Container(
                ...
                child: Text(
                  'Monday League Scores for $_selectedPlayer',
                  style: TextStyle(
                    fontSize: 18,
                        ...
                        ? Center(
                            child: Column(
                              ...
                              children: [
                                ...
                                const Text(
                                  'No scores found for this Monday league player',
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 20),
                      Text(
                        'Select a Monday League player to view their scores',
                        style: TextStyle(
                          fontSize: 18,
          ...
          child: ListTile(
            ...
            subtitle: Column(
              ...
              children: [
                ...
                Text('SKAT Score: ${score['skats_score'] ?? 'N/A'}'),
                Text('Winnings: \$${score['skat_winnings']?.toStringAsFixed(2) ?? '0.00'}'),
              ],
            ),
            trailing: Icon(
              Icons.golf_course,
