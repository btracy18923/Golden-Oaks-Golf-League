...
# (str) Main module filename (if not main.py)
main.filename = simple_main.py
...
# version.filename = %(source.dir)s/main_unified_golf_app.py
...
icon.filename = ../images/GoldenOaks.png
